            ...
            <section className="footer">
                <div className="containers">
                    <div className="footer__top">
                        <div className="footer__column footer-hidden-tablet">
                            <a href=""> <img className="logo" src="./img/logo1.svg" alt=""/>
                            </a>
                            <p className="footer__desc">M.O.I là thương hiệu mỹ phẩm trang điểm chuyên nghiệp đầu tiên tại Việt Nam với tiêu chuẩn chất lượng quốc tế và giá hợp lý dành cho phụ nữ Việt.

                                M.O.I luôn đồng hành cùng các chuyên gia hàng đầu trong ngành mỹ phẩm thế giới & những biểu tượng sắc đẹp tại Việt Nam để tạo ra những dòng sản phẩm chất lượng, phù hợp với phong cách, khí hậu và thu nhập của người Việt.</p>
                        </div>
                        <div className="footer__column">
                            <h3 className="footer__heading">Hỗ trợ</h3>
                            <ul className="footer__list">
                                <li className="footer__item"><a className="footer__link" href="">Chính sách đổi trả</a></li>
                                <li className="footer__item"><a className="footer__link" href="">Bảo mật</a>
                                </li>
                                <li className="footer__item"><a className="footer__link" href="">Giới thiệu</a></li>
                                <li className="footer__item"><a className="footer__link" href="">Về chúng tôi</a></li>

                            </ul>
                            <h3 className="footer__heading">Thanh toán và giao nhận</h3>
                            <ul className="footer__list">
                                <li className="footer__item"><a className="footer__link" href="">Liên hệ</a></li>
                                <li className="footer__item"><a className="footer__link" href="">Xử lý khiếu nại</a>
                                </li>
                        ...
                        <div className="footer__column">
                            ...
                            <ul className="footer__list">
                                <li className="footer__item"><a className="footer__link" href="">SĐT:0396671835</a></li>
                                <li className="footer__item"><a className="footer__link" href="">Email:hieuhuyphantn@gmail.com</a>
                                </li>


                            </ul>
                            <h3 className="footer__heading">Địa chỉ</h3>
                            <ul className="footer__list">
                                <li className="footer__item"><a className="footer__link" href="">Kim Chung, Hoài Đức, Hà Nội</a></li>
                        ...
                        <div className="footer__column">
                            <h3 className="footer__heading">Tìm đến tôi </h3>
                            ...
                            <h3 className="footer__heading">Đăng ký</h3>
                            <p className="footer__desc">Điền mail để cập nhật sản phẩm mới nhất
                                </p>
                            <form className="footer__form">
                                <input type="email" className="foot-form__input" placeholder="Nhập email..."/>
                                <button className="footer-form__submit">Gửi</button>
                            </form>
                        </div>
                    </div>
                    <div className="footer__copyright">
                        <p className="footer__copyright-text">2024 M.O.I clone web vui lòng không reup dưới mọi hình thức.</p>
                    </div>
                </div>
            </section>
